...
export function HomeNetDashboard() {
  ...
  async function resetUsage() {
    ...
    else setNotice({ kind: "ok", text: "تم حذف القراءات القديمة وتصفير عداد كل الأجهزة. بدأ الحساب من الآن." });
    await loadDashboard();
  }
